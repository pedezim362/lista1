        ...
        <div class="relative h-10 w-16 shrink-0 overflow-hidden rounded bg-gray-100 dark:bg-gray-700">
            ...
            @else
                <div class="flex h-full items-center justify-center">
                    ...
                    @elseif($item->isImage())
                        <x-heroicon-o-photo class="w-5 h-5 text-blue-400" />
                    @elseif($item->isDocument())
                        <x-heroicon-o-document-text class="w-5 h-5 text-green-400" />
                    @elseif($item->isAudio())
                        <x-heroicon-o-musical-note class="w-5 h-5 text-purple-400" />
                    @else
